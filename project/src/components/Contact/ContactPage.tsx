...
export default function ContactPage() {
  return (
    <section className="flex justify-center px-4 pt-4 pb-8 bg-transparent">
      <div className="bg-white rounded-lg shadow-lg p-8 w-full max-w-6xl flex flex-col md:flex-row items-start md:items-start gap-2">
        {/* Left: Contact Info */}
        <div className="flex-1 space-y-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-lg text-dark-purple-900">+55 (83) 9123-0473</span>
          </div>
          <div className="flex items-center gap-3">
