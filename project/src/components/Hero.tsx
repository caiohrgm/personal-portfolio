...
export default function Hero() {
  return (
    <section className="flex flex-col-reverse md:flex-row items-center justify-center flex-grow px-8 py-12 md:py-24 bg-[#080808]">
      <div className="text-center md:text-left max-w-lg py">
        <h1 className="text-5xl font-bold font-raleway">Caio Medeiros</h1>
        <p className="text-[#9C9C9C] mt-4 font-mono">
          Software Engineer and Data Scientist, focused on back-end.
        </p>
