    ...
    <header className="fixed top-0 left-0 w-full z-50 bg-light-purple-300 border-b border-gray-700">
      <div className="max-w-6xl mx-auto py-4 px-6 sm:px-8 flex justify-between items-center">
        ...
        <nav className="hidden sm:flex space-x-6 text-lg text-vanilla-gray-300 font-mono">
          ...
          <Link to="/skills" className="hover:text-mint-300 cursor-not-allowed pointer-events-none opacity-50">Skills</Link>
      ...
      {isOpen && (
        <div className="sm:hidden px-6 py-4 bg-light-purple-300 border-t border-gray-700 text-vanilla-gray-300 font-mono space-y-2">
          ...
          <Link to="/skills" className="block hover:text-mint-300 cursor-not-allowed pointer-events-none opacity-50" onClick={() => setIsOpen(false)}>Skills</Link>
          <Link to="/articles/scientific-papers" className="block hover:text-mint-300 cursor-not-allowed pointer-events-none opacity-50" onClick={() => setIsOpen(false)}>Scientific Papers</Link>
          <Link to="/articles/personal-articles" className="block hover:text-mint-300 cursor-not-allowed pointer-events-none opacity-50" onClick={() => setIsOpen(false)}>Personal Articles</Link>
