...
import { projects } from "./Data/presentationProjectData/projecstsData";

export default function ListOfProjects() {
  return (
    <section className="bg-white text-gray-800 py-6 sm:px-8 rounded-b-lg">
      <div className="max-w-6xl mx-auto px-4 sm:px-8">
        ...
        <div className="overflow-x-auto flex space-x-8 pb-8 scroll-smooth custom-scrollbar">
          {Object.entries(projects).map(([slug, project]) => (
            <div
              key={slug}
              className="bg-vanilla-gray-300 text-light-purple-300 border border-light-purple-300 p-6 rounded-lg flex-shrink-0 w-80"
            >
